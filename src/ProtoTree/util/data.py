...
def get_data(args: argparse.Namespace): 
    ...
    if args.dataset == 'traffic_signs':
        return get_traffic_signs(
            True,
            train_dir   = "../crops_split/train",
            project_dir = "../crops_split/train",
            test_dir    = "../crops_split/test",
        )
...
def get_traffic_signs(augment: bool, train_dir: str, project_dir: str, test_dir: str, img_size=224):
    shape = (3, img_size, img_size)
    mean  = (0.485, 0.456, 0.406)
    std   = (0.229, 0.224, 0.225)
